...
public class IndexController {
    ...
    public String spike() {
        ...
        try {
            ...
            System.out.println("seckill2 result:" + result);
            log.info("seckill2 result:" + result);
            if(result) {
                index ++;
                System.out.println("seckill2 index:" + index);
                log.info("seckill2 index:" + index);
                int stock = Integer.parseInt(redisTemplate.opsForValue().get(commodityCount).toString());
                log.info("seckill2 stock:" + stock);
                System.out.println("seckill2 stock:" + stock);
                if(stock > 0) {
